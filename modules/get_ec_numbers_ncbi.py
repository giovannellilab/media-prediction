...
# Because multiple EC numbers can be present separated by tab, we need to change
# the xtract command. Running the command in the terminal, returns the
# expanded command: "xtract -insd Protein EC_number" converts into
